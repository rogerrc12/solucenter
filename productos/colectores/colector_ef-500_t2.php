      ...
      <div class="container pb-5">
        ...
        <div class="row">
            ...
            <section class="col-12 col-lg-6">
                ...
                <p>El colector EF-500 T2 es un equipo estacionario, desarrollado para captar polvo en máquinas medianas, como escuadradoras, seccionadoras, lijadoras. Puede ser utilizado en dos o más máquinas al mismo tiempo, dependiendo de las necesidades individuales de cada equipo.</p>
                ...
                <ul>
                    <li class="mb-2">Se comercializa con cuatro entradas de 4 "(100 mm), para conectar una o varias máquinas. Puede recibir una serie de entradas con diferentes diámetros.</li>
