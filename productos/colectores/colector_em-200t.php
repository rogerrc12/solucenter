      ...
      <div class="container pb-5">
        ...
        <div class="row">
            ...
            <section class="col-12 col-lg-6">
                ...
                <p>El Colector EM-200T se comercializa con dos entradas de 100 mm (4 ") para conectar una o varias máquinas. Construido en acero tubular y con ruedas industriales, es el equipo perfecto cuando hay necesidad de desplazamiento de éste dentro de la fábrica.</p>
                ...
                <ul>
                    ...
                    <li class="mb-2">La carcasa de la campana está confeccionada en plástico especial, de alta resistencia, bajo fricción y más ligero.</li>
