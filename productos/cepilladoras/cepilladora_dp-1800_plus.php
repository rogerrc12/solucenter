      ...
      <div class="container pb-5">
        ...
        <div class="row">
            ...
            <section class="col-12 col-lg-6">
                ...
                <p>Profesionalismo para quien está acostumbrado a la calidad. La fabricación de muebles a medida y escuadras exige equipos profesionales, por lo que INMES ha desarrollado para usted la Desempenadora DP-1800 Plus.</p>
                ...
                <ul>
                    ...
                    <li class="mb-2">La regulación de la guía de la DP-1800 Plus se realiza manualmente, a través de guías lo que garantiza precisión.</li>
                    
                    <li class="mb-2">En la Desempenadora DP-1800 Plus es posible regular la altura de la mesa de salida, con rapidez y precisión.</li>

                    <li class="mb-2">La Guía de la Desempenadora DP-1800 Plus tiene para mayor precisión: ajuste fino en los ángulos de 45 ° y 90 ° y se puede regular en cualquier posición entre estos dos ángulos.</li>
                </ul>
