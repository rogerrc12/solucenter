      ...
      <div class="container pb-5">
        ...
        <div class="row">
            ...
            <section class="col-12 col-lg-6">
                ...
                <p>Profesionalismo para quien está acostumbrado a la calidad. La fabricación de muebles a medida y escuadras, requiere equipamiento profesional, por lo que INMES ha desarrollado para usted la Desempenadora DP-1500 Plus.</p>
                ...
                <ul>
                    ...
                    <li class="mb-2">La regulación de la guía de la DP-1500 Plus se realiza a través de una cremallera, lo que garantiza rapidez y precisión.</li>
                    
                    <li class="mb-2">En la Desempenadora DP-1500 Plus es posible regular la altura de la mesa de salida, con rapidez y precisión.</li>

                    <li class="mb-2">La guía de la Desempenadora DP-1500 Plus posee para mayor precisión, ajuste fino en los ángulos de 45 ° y 90 ° y se puede regular en cualquier posición entre estos dos ángulos.</li>
                </ul>
