        ...
        <div class="row">
            ...
            <section class="col-12 col-lg-6">
                ...
                <ul>
                    ...
                    <li class="mb-2">En la IM-300PL AL, usted acciona el presionador a través de las botoneras, garantizando que el perfil esté bien fijo, en la secuencia, automáticamente los discos de sierra bajan efectuando el corte.</li>
                    ...
                    <li class="mb-2">Desarrollado para apoyar los perfiles de aluminio, del lado derecho o izquierdo, La Sierra Doble IM-300PL AL. El prolongador derecho vienen con la máquina, los prolongadores izquierdo, adicionalderecho e izquierdo, son opcionales.</li>
                ...
                <ul>
                    <li class="mb-2">Equipamiento compuesto por: Máquina IM-300PL AL, Prolongador de rodillo derecho, Lámina de sierra 300 x 30 x 3,2 z 120, para corte de aluminio, Aspersor neumático, Tope para perfil.</li>
