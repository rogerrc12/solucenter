        ...
        <div class="row">
            ...
            <section class="col-12 col-lg-6">
                ...
                <ul>
                    ...
                    <li class="mb-2">Desarrollado para prolongar el lado derecho de la mesa de la Sierra Doble IM-300 P, cuando la necesidad de cortar perfiles es de hasta 1970 mm. (Item opcional)</li>
                    
                    <p class="text-uppercase font-weight-bold mb-1">PROLONGADOR IZQUIERDO</p>
                    <li class="mb-2">Desarrollado para prolongar el lado izquierdo de la mesa de la Sierra Doble IM-300 P, cuando la necesidad de cortar perfiles es de hasta 1970 mm.</li>
                    
                    <p class="text-uppercase font-weight-bold mb-1">PROLONGADOR ADICIONAL DERECHO</p>
                    <li class="mb-2">Desarrollado para aumentar el prolongador, en el lado derecho, de la mesa de la Sierra Doble IM-300 P, cuando la necesidad de cortar perfiles es de hasta 2965 mm. (Item opcional)</li>
                    
                    <p class="text-uppercase font-weight-bold mb-1">BOTONERA DOBLE</p>
                    <li class="mb-2">En la IM-300P, usted acciona el presionador a través de las botoneras, garantizando que el perfil esté bien fijo, en la secuencia, automáticamente los discos de sierra bajan efectuando el corte.</li>
                ...
                <ul>
                    <li class="mb-2">Equipamiento compuesto por: Máquina IM-300 P, disco de sierra de 300 mm de diámetro, para corte de madera, tope para perfil.</li>
