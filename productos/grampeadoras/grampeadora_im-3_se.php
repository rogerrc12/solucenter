        ...
        <div class="row">
            ...
            <section class="col-12 col-lg-6">
                ...
                <ul>
                    ...
                    <li class="mb-2">Los magazines para las grapas 5, 7, 10, 12 y 15 mm, pueden ser cambiados rápidamente gracias al moderno diseño de la encimera.</li>
                ...
                <ul>
                    ...
                    <li class="mb-2">Producción de 800 a 1000 cuadros por turno de 8 horas</li>
                    <li class="mb-2">Fácil utilización, con accionamiento a pedal mecánico, no necesitando compresor de aire o energía eléctrica</li>
                    ...
                    <li class="mb-2">Posee regulación de altura del pedal</li>
