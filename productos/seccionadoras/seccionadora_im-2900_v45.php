      ...
      <div class="container pb-5">
        ...
        <div class="row">
            ...
            <section class="col-12 col-lg-6">
                ...
                <p>Una máquina moderna y accesible para quienes no renuncian a una ventaja rentable. Además de su diseño, la IM-2900 V45 viene equipada con el moderno sistema "Auto Speed" que garantiza una mayor productividad con velocidad de hasta 45 m / min y el sistema "Eco Motion" que proporciona hasta un 70% de ahorro de energía.
                    <br>
                    <br> 
                    Una gran novedad de la IM-2900 V45, es el novedoso sistema - <strong>AUTO SPEED</strong>. Con velócidad de corte máxima de 30 m/min, el Auto Speed garantiza que la sierra corte siempre con la velócidad ideal, en función del tipo de material, del espesor del material y del filo de la lámina de sierra.
                    <br>
                    <br>
                ...
                <ul>
                    ...
                    <li class="mb-2">Para comandar la IM-2900 V45, Usted cuenta con un panel Touch Screen de fácil acceso, en donde puede encender/apagar el disco de sierra, abrir las puertas de mantenimientopara el cambio de la sierra, incisor y lubricación, controlar la velocidad de corte, controlar tamaño del corte y la cantidad de corte.</li>
                    ...
                    <li>Para un ambiente más saludable y economía de espacio, la IM-2900 V30 está construida con un sistema de extracción tipo corredera, otorgando mayor eficiencia de captación de polvo y mayor durabilidad al conjunto (no usa mangueras en la parte interna) y posee solamente un punto de capatación, en la parte inferior de la máquina. <br> Para un ambiente más sano, se construye con un sistema de extracción tipo corredera, otorgando mayor eficiencia de captación de polvo y mayor durabilidad al conjunto (no usa mangueras en la parte interna).</li>
                </ul>
                ...
                <ul>
                    ...
                    <li class="mb-2">Gráfico de consumo de corriente en el panel</li>
