        ...
        <div class="row">
            ...
            <section class="col-12 col-lg-6">
                ...
                <p>Una novedad en el mercado del mueble, garantizando Más Flexibilidad, Economía, Productividad y la Calidad que usted ya conoce!
                    <br><br> 
                    La fabricación de muebles a medida, requiere equipos profesionales y cada vez mas flexibles. El acceso a los mas variados formatos de MDF y Melamina, esto exige máquinas versatiles, por eso INMES, desarrollo la IC-2003 RP Electronic, que cuenta con un rápido sistema de cambio de calderín, proporcionandole a Ud., amigo carpintero, flexibilidad en el día a día.
                    <br><br>
                    Con un moderno panel, la IC-2003 RP Electronic entra en modo de espera bajando la temperatura del pegamento automáticamente, después de 15 minutos si la máquina no está siendo utilizada, evitando el recalentamiento del pegamento y el consumo de energía.
                    <br><br>
                    La nueva IC-2003 RP Electrónic está mas rápida, ahora Ud. Puede enchapar con velócidad de 12 m/min aumentando de esta forma la productividad de su carpintería.
                    <br><br>
                    La IC-2003 RP Electrónic, pegamento refila y pule. Con panel moderno e inteligente, además de proporcionar la economía de energia, aumeta la vida útil de los componentes.
                </p>
                ...
                <ul>
                    ...
                    <li class="mb-2">En la enchapadora IC-2003 RP Plus Electronic, es posible cambiar el calderín de forma práctica y rápida, garantizando mayor productividad en el uso de varios tipos de adhesivos. (Segundo calderín es opcional)</li>
                    ...
                    <li class="mb-2">Con un sistema de regulación práctica, el conjunto refilador de la IC-2003 RP Plus Electronic está equipado con 2 fresas accionadas por 2 motores de 1 HP cada uno, trabajando a 12.000 rpm, proporcionando un acabado superior.</li>
