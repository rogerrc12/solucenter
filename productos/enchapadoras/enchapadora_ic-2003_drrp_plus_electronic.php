        ...
        <div class="row">
            ...
            <section class="col-12 col-lg-6">
                ...
                <p>Una novedad en el mercado del mueble, garantizando Más Flexibilidad, Economía, Productividad y la Calidad que usted ya conoce!
                    <br><br> 
                    La fabricación de muebles a medida, requiere equipos profesionales y cada vez mas flexibles. El acceso a los mas variados formatos de MDF y Melamina, esto exige máquinas versatiles, por eso INMES, desarrollo la IC-2003 DRRP Electronic, que cuenta con un rápido sistema de cambio de calderín, proporcionandole a Ud., amigo carpintero, flexibilidad en el día a día.
                    <br><br>
                    Con un moderno panel, la IC-2003 DRRP Electronic entra en modo de espera bajando la temperatura del pegamento automáticamente, después de 15 minutos si la máquina no está siendo utilizada, evitando el recalentamiento del pegamento y el consumo de energía.
                    <br><br>
                    La nueva IC-2003 DRRP Electrónic está mas rápida, ahora Ud. Puede enchapar con velócidad de 12 m/min aumentando de esta forma la productividad de su carpintería.
                    <br><br>
                    La IC-2003 DRRP Electrónic, pegamento refila y pule. Con panel moderno e inteligente, además de proporcionar la economía de energia, aumeta la vida útil de los componentes.
                </p>
                ...
                <ul>
                    ...
                    <li class="mb-2">En la enchapadora IC-2003 DRRP Plus Electronic, es posible cambiar el calderín de forma práctica y rápida, garantizando mayor productividad en el uso de varios tipos de adhesivos. (Segundo calderín es opcional)</li>
                    ...
                    <p class="text-uppercase font-weight-bold mb-1">CONTROL DE ENTRADA DE PIEZAS</p>
                    <li class="mb-2">La IC-2003 DRRP Plus Electrónic es equipada con un controlador de entrada de piezas mecánico y luminoso, para evitar el choque accidental del destopador con estas.</li>
                    ...
                    <p class="text-uppercase font-weight-bold mb-1">DESTOPADOR</p>
                    <li class="mb-2">El conjunto destopador está equipado con 2 discos de sierra accionadas por 2 motores de 0.5 HP cada uno, trabajando a 12,000 rpm proporcionando un acabado superior.</li>
                    ...
                    <p class="text-uppercase font-weight-bold mb-1">RASPADOR</p>
                    <li class="mb-2">El raspador de la IC-2003 DRRP Plus Electronic es de fácil regulación y permite retirar el exceso de pegamento que por ventura quede en la pieza, mejorando el acabado y aumentando la vida útil del pulidor.</li>

                    <p class="text-uppercase font-weight-bold mb-1">PRE-CALENTADOR</p>
                    <li class="mb-2">El precalentador calienta la pieza, para que ésta al entrar en contacto con el adhesivo no lo enfríe y elimine la humedad en la pieza, aumentando la calidad del enchapado.</li>

                    <p class="text-uppercase font-weight-bold mb-1">CAMBIO DE CANTO</p>
                    <li class="mb-2">En la canteadora IC-2003 DRRP Plus Electrónic. Cambiar el grosor del canto es muy fácil. Puede utilizar un pedazo de cinta con el grosor deseado, como referencia para el ajuste.</li>
