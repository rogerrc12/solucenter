      ...
      <div class="container pb-5">
        ...
        <div class="row">
            ...
            <section class="col-12 col-lg-6">
                ...
                <p>Las grapas WP INMES se utilizan para la unión de perfiles de madera o plástico, en la fabricación de cuadros, porta retratos, muebles, puertas, ventanas, entre otros.</p>
                ...
                <ul>
                    ...
                    <li class="mb-2">Con perfil de anchura 11 mm, la grapa "WP" fue diseñada para máquinas Alfamacchine / Minigraf.</li>
                ...
                <ul>
                    <li class="mb-2">Tipo WP utilizado en máquinas Alfamacchine / Minigraf (11mm ancho)</li>
