      ...
      <div class="container pb-5">
        ...
        <div class="row">
            ...
            <section class="col-12 col-lg-6">
                ...
                <p>Desarrollado para la fijación de fondos de puerta retratos, reemplazando las populares tramillas.</p>
                ...
                <ul>
                    ...
                    <li class="mb-2">Utilizado en la pistola FI 140P Inmes</li>
