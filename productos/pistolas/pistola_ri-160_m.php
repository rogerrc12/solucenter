      ...
      <div class="container pb-5">
        ...
        <div class="row">
            ...
            <section class="col-12 col-lg-6">
                ...
                <p>Equipo desarrollado principalmente para aplicar Rigipuntas® Inmes en cuadros de decoración, indicado para fabricas con pequeño volumen de producción.</p>
                ...
                <ul>
                    <li class="mb-2">Tiene un diseño moderno y ergonómico que facilita la aplicación del rigipunta.</li>
                    <li class="mb-2">La manija de accionamiento está recubierta de material de caucho mejorando el rendimiento debido a su ergonomía.</li>
                    <li class="mb-2">Botón de regulación de la profundidad de las Rigipuntas, permite al operador regular la profundidad de penetración de los Rigipuntas en función de la dureza del material del cuadro.</li>
                    <li class="mb-2">* El botón de apertura del cargador se coloca en la parte superior de la pistola, facilitando la apertura del cargador y la recarga de la Rigipuntas.</li>
                </ul>
                <h4 class="H4 font-weight-bold">Caracteristicas</h4>
                <ul>
                    <li class="mb-2">Capacidad de carga: Aproximadamente 200 Rigipuntas® Inmes</li>
                    ...
                    <li class="mb-2">Posee regulador de potencia de aplicación del Rigipontas®</li>
