      ...
      <div class="container pb-5">
        ...
        <div class="row">
            <section class="col-12 col-lg-6">
                <div class="imgBox">
                    <img src="<?php echo "../../img/productos/perforadoras/$producto.png" ?>" alt="<?php $producto ?>">
                </div>
                <ul class="thumb list-inline">
                    <li class="list-inline-item">
                        <a href="<?php echo "../../img/productos/perforadoras/$producto.png" ?>" target="imgBox"><img src="<?php echo "../../img/productos/perforadoras/$producto.png" ?>" alt="<?php $producto ?>"></a>
                    </li>
                    <li class="list-inline-item">
                        <a href="<?php echo "../../img/productos/perforadoras/$producto.png" ?>" target="imgBox"><img src="<?php echo "../../img/productos/perforadoras/$producto.png" ?>" alt="<?php $producto ?>"></a>
                    </li>
