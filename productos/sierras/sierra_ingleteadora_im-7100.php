      ...
      <div class="container pb-5">
        ...
        <div class="row">
            ...
            <section class="col-12 col-lg-6">
                ...
                <p>La INMES presenta la Sierra ingleteadora Telescópica IM-7100, más silenciosa y robusta del mercado. Indicada para uso en cerrajerías, carpinterías, fábricas de muebles, construcción civil y decoradores.</p>
                ...
                <ul>
                    <li class="mb-2">Acompaña lámina de sierra Ø300 x 2,8 / 2,0 x 30 z 28</li>
                    <li class="mb-2">Motor de inducción de 1600 W (no utiliza carbón)</li>
