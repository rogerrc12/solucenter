      ...
      <div class="container pb-5">
        ...
        <div class="row">
            ...
            <section class="col-12 col-lg-6">
                ...
                <p>La INMES presenta la Sierra de 1/2 Escuadra con Mesa Superior IM-8200, más silenciosa y robusta del mercado Indicada para uso en molduras, cerrajerías, carpinterías, fábricas de muebles, construcción civil y decoradores.</p>
                ...
                <ul>
                    ...
                    <li class="mb-2">Mesa superior, para refilar</li>
                    <li class="mb-2">Regulación de altura de la mesa superior</li>
