      ...
      <div class="container pb-5">
        ...
        <div class="row">
            ...
            <section class="col-12 col-lg-6">
                ...
                <p>
                    Alta tecnología para quien está acostumbrado a la calidad. La fabricación de cuadros y muebles, no permite errores, es una actividad que involucra diseño y arte, por lo que Inmes ha desarrollado para usted la Sierra ½ Esquadria IM-30 SM, para solucionar sus problemas de corte en perfiles de madera y plástico, desperdicio de tiempo y material.
                </p>
                ...
                <ul>
                    ...
                    <li class="mb-2">La IM-30 SM tiene una salida de polvo con diámetro amplio haciendo que al conectar un exaustor adecuado, permita que el 97% del polvo sea recolectado.</li>

                    <li class="mb-2">El cojinete de hierro fundido da mayor rigidez al equipo, aumentando la calidad del corte.</li>

                    <li class="mb-2">La batidora móvil para perfil, que acompaña el prolongador, garantiza la repetibilidad de los cortes con precisión.</li>

                    <li class="mb-2">En la IM-30 SM acompaña los prolongadores derecho e izquierdo. Estos prolongadores poseen escalas en milímetros,  para facilitar la medición del perfil, además de servir de apoyo para estos perfiles, durante el corte.</li>
                </ul>
                ...
                <ul>
                    <li class="mb-2">Equipamiento compuesto por: Sierra ½ Esquadria IM-30, Lámina de sierra 300x30x3,0 z 90 (madera), Prolongadores Derecho, Prolongador Izquierdo, Base Aspirante, Parada móvil</li>
